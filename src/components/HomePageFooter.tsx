...
export const HomePageFooter = ({ loaded }: HomePageFooterProps) => {
  ...
  return (
    <>
      ...
      <footer className={`border-t border-slate-200/50 dark:border-zinc-800/50 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm transition-all duration-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
